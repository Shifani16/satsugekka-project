...
const TranslationCard: React.FC<TranslationCardProps> = ({
  ...
  return (
    <div className="grid grid-cols-2 w-full md:w-3/4 border mt-8 md:mt-10 border-accent rounded-xl bg-white/8 min-h-45 overflow-hidden transition-all duration-300 hover:scale-101 cursor-pointer">
